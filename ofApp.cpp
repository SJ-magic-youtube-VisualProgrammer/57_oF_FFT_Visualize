	...
	********************/
	...
	if( soundStream_Input_DeviceId == -1 ){
		...
		********************/
		...
		DancingCloud.setup(AUDIO_BUF_SIZE/2);
...
void ofApp::update(){
	...
	********************/
	...
	/********************
	********************/
	DancingCloud.update(fft_thread);
}
